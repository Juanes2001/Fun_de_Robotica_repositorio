...
typedef struct{
	...
	volatile int lesserFcostPosition[2]; // En este arreglo podemos subir la posicion del Fcost mas pequeño que queramos para usarla despues
	volatile int lesserHcostPosition[2]; // En este arreglo podemos subir la posicion del Hcost mas pequeño que queramos para usarla despues
